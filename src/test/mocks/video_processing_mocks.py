...
video_path_list = ['fixtures/raw_videos/consultant-12-session-01-part-02-section-02.mp4',
                   'fixtures/raw_videos/consultant-12-session-01-part-02-section-02.mp4',
                   'fixtures/raw_videos/consultant-12-session-01-part-02-section-02.mp4',
                   'fixtures/raw_videos/consultant-12-session-01-part-02-section-02.mp4',
                   'fixtures/raw_videos/consultant-12-session-01-part-02-section-02.mp4',
                   'fixtures/raw_videos/consultant-12-session-01-part-02-section-02.mp4',
                   ...
                   'fixtures/raw_videos/consultant-12-session-01-part-02-section-02.mp4',
                   'fixtures/raw_videos/consultant-12-session-01-part-02-section-02.mp4',
                   'fixtures/raw_videos/consultant-02-session-01-part-01-00.mp4',
                   'fixtures/raw_videos/consultant-12-session-01-part-02-section-02.mp4',
                   'fixtures/raw_videos/consultant-24-session-01-part-03.mp4',
                   'fixtures/raw_videos/consultant-12-session-01-part-02-section-02.mp4',
                   'fixtures/raw_videos/consultant-12-session-01-part-02-section-02.mp4']
...
def extract_sample_some_invalid(video_path, start_time, end_time):
    return (True, get_sample_mock('fixtures/extracted_person_sample/')) \
        if video_path == 'fixtures/consultant-12-session-01-part-02-section-02.mp4' else (False, None)
