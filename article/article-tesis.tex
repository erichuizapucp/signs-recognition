...
\textbf{Bag of Words (BoW)} or \textbf{Bag of Visual Words (BoVW)} when applied to Computer Vision is a technique used for images classification by counting the number of occurrences of a set of image features. 
Scale-invariant feature transform
\\
Feature trajectory detection are much improved using statistical methods like \textbf{Fisher Vectors} obtaining better results over traditional BoW \textbf{Fussing parallel CNN.}
